...
(async () => {
    ...
    let network = mode[1];
    if(!BlockchainConfig.network[network].BLOCKCHAIN_RPC_FLASHLOANER_PROVIDER){
    ...
    try {
        ...
        logContent.rpc = BlockchainConfig.network[network].BLOCKCHAIN_RPC_FLASHLOANER_PROVIDER;
